Public Class Form6
    ...
    Dim line As Integer                         '縮邊時間
    Dim a As Integer                            '縮邊邊界
    '------------------------------------------1P-控制--------------------------------------------------------------------------------
    '1P角色控制(上)(function)
    ...
    Private Sub die1()
        If invincible = 2 Or invincible = 0 Then
            ...
            If xy1 >= tnt2xy - 2 And xy1 <= tnt2xy + 2 Then
                ...
                End If
            End If
            If y1 = 13 - a Or x1 = 17 - a Or y1 = 1 + a Or x1 = 1 + a Then
                death1 = 1
            End If
        End If
    End Sub
    ...
    Private Sub die2()
        If invincible = 1 Or invincible = 0 Then
            ...
            If xy2 >= tnt2xy - 2 And xy2 <= tnt2xy + 2 Then
                ...
                End If
            End If
            If y2 = 13 - a Or x2 = 17 - a Or y2 = 1 + a Or x2 = 1 + a Then
                death2 = 1
            End If
        End If
    End Sub
    ...
    Private Sub Form6_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If music = 0 Then
            ...
            End If
        ElseIf music = 1 Then
            player.URL = My.Application.Info.DirectoryPath & "\sound\bgm\Dies Irae.mp3"
        ElseIf music = 2 Then
            player.URL = My.Application.Info.DirectoryPath & "\sound\bgm\+9.mp3"
        ElseIf music = 3 Then
            player.URL = My.Application.Info.DirectoryPath & "\sound\bgm\apple.mp3"
        End If
    End Sub
    ...
    Private Sub Timer7_Tick(sender As System.Object, e As System.EventArgs) Handles Timer7.Tick
        If border = True Then
            line += 1
            If line Then
                PictureBox2.Top += PictureBox144.Height
                PictureBox1.Top -= PictureBox144.Height
                PictureBox4.Left += PictureBox144.Width
                PictureBox3.Left -= PictureBox144.Width
                a += 1
            End If
            die1()
            die2()
            If death1 = 1 Or death2 = 1 Then
                ending2()
            End If
        End If
    End Sub
